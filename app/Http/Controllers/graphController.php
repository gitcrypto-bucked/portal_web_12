...
{
    public function getTotalFaturamento($idCliente,$periodo_fim= '10-22-24', $json = false)
    {
    ...
    public function  getPaginasMês($idCliente,  $periodo_fim= '10-22-24',  $json = false)
    {
        $model = new graphModel();
   ...
   public function getChamadosGraph($idCliente, $periodo_inicio='09-23-24', $periodo_fim= '10-22-24' , $json = false)
   {
       ...
       if(!$json)
       {
           return [$fora,  $dentro, [ date('d/m/Y', strtotime(str_replace('-', '/', $periodo_inicio))) ,
   ...
   public function getSLADentroPercent($idCliente, $periodo_inicio='09-23-24', $periodo_fim= '10-22-24', $json = false)
   {
       $model = new graphModel();
       ...
       if(!$json)
       {
           return [[$st,$end], $target, $total];
       }
       else if($json)
       {
           return  json_encode(['status'=>200,'dataset'=>[$st,$end],'target'=> $target,'total'=> $total]);
       }
   }
