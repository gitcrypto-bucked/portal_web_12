...
{
    public function getDataFaturamento($idCliente, $periodo_inicio='09-23-24', $periodo_fim= '10-22-24')
    {
    ...
    public  function  getTotalPrint($idCliente, $periodo_fim= '10-22-24')
    {
    ...
    public function  getTotalFaturamento($idCliente, $periodo_fim= '10-22-24')
    {

        return DB::select("SELECT SUM(f.total_geral) as tot,f.periodo_inicio , f.periodo_fim  FROM faturamento f
                                 JOIN localidades  l
                                 ON f.localidade = l.localidade
                                 JOIN clientes c ON l.idCliente = c.idCliente
                                 WHERE  f.periodo_fim='".$periodo_fim."'
